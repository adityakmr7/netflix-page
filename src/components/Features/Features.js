...
`;
//red bottom border on selected Features
...
class features extends Component {
    ...
    render() { 
        const {cancelContent, watchContent, priceContent, width} = this.state;
                ...
                <Features>
                    <div className="featureNav">
                        ...
                        <a onClick={(e)=> this.toggleContent2(e)}>
                            <svg className={!cancelContent ? 'selected': ''} viewBox="0 0 91 48" width="100%" height="34px" version="1.1" xmlns="http://www.w3.org/2000/svg">
                                <g>
                            ...
                            <h2 className={!watchContent ? 'selected': ''}>Devices</h2>
                            <br/>
